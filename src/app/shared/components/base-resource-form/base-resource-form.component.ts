...
export abstract class BaseResourceFormComponent<T extends BaseResourceModel> implements OnInit, AfterContentChecked {
    ...
    constructor(
        ...
        public resource: T, // Ex.: new Category()
    ...
    protected createResource() {
        const resource: T = this.jsonDataToResourceFn(this.resourceForm.value); // cria uma nova categoria ja setando os valores do form
